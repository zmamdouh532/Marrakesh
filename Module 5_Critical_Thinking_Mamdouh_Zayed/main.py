...
class WorkOrder:
    ...
    def calculate_cost(self) -> object:
        ...
        return 25 * self.hours_applied * self.num_people * 200 if self.equipment else 1 * self.filler_material_used
    def print(self):
...
work_order = phtrs_system.assign_work_order(pothole, "Crew001", 3, 200, 8, "Work in Progress", 5)
damage_report = phtrs_system.report_damage("John Doe", "456 Oak St", "555-1234", "Flat tire", 100)


# print actors - reporting citizen, repairmen
# print use cases - citizen report, pothole repair
